    ...
    for (let i = 0; i < data.length; i += 1) {
      ...
      $("#listItems").append(`
        <tr>
          ...
          <td><button class="completedButton" data-id=${task.id}  data-completed=${task.completed} >${task.completed ? "Not Completed": "Completed"}</button></td>
...
//   };
  ...
  function postItem(){
    ...
    console.log("in posttask on add button click")
    let taskToSend = {
        task: task,
        completed: completed,
      };
